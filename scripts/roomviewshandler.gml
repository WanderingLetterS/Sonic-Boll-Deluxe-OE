...
do {
    ...
    if (rm=scoring || rm=game || rm=change) {
        ...
        if (global.mplay=2) {
            room_set_view(rm,0,1,0,0,400,224,0,0,400*s,224*s,0,0,0,0,noone)
            room_set_view(rm,1,1,0,0,400,224,0,228*s,400*s,224*s,0,0,0,0,noone)
        }
        if (global.mplay=3) {
            room_set_view(rm,1,1,0,0,400,224,404*s,0,400*s,224*s,0,0,0,0,noone)
            room_set_view(rm,2,1,0,0,400,224,204*s,228*s,400*s,224*s,0,0,0,0,noone)
        }
        if (global.mplay=4) {
            room_set_view(rm,1,1,0,0,400,224,404*s,0,400*s,224*s,0,0,0,0,noone)
            room_set_view(rm,2,1,0,0,400,224,0,228*s,400*s,224*s,0,0,0,0,noone)
            room_set_view(rm,3,1,0,0,400,224,404*s,228*s,400*s,224*s,0,0,0,0,noone)
        }
    }
