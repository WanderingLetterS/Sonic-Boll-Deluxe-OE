...
if (fadekill) {
    ...
    //check globalmanager draw event

    exit
}

if (input_esc() && !instance_exists(console)) menu_cancel()
if ((room!=lemon && room!=speciale) || global.allowconsoleinlemon) if (keyboard_check_pressed(vk_tab)) if (!instance_exists(console)) {
