...
var sndp;
sndp=skindat("snd_enemybombfuseinst")
if (sndp) FMODInstanceSetPause(sndp,1)
sndp=skindat("snd_enemybombwarninst")
if (sndp) FMODInstanceSetPause(sndp,1)
sndp=skindat("snd_enemybigexplodeinst")
if (sndp) FMODInstanceSetPause(sndp,1)
sndp=skindat("snd_enemyexplodeinst")
if (sndp) FMODInstanceSetPause(sndp,1)
