...
instance_activate_object(shell)
...
repeat(ds_list_size(list)) {
    instance_deactivate_object(ds_list_find_value(list, i));
    i+=1;
}
ds_list_destroy(list);
instance_deactivate_object(onoffscreen)
instance_deactivate_object(signalcommunicator)
instance_deactivate_object(ireader)
instance_deactivate_object(detector)
instance_deactivate_object(variableblock)
instance_deactivate_object(gobble)
instance_deactivate_object(displayscreen)
instance_deactivate_object(variableblock)
instance_deactivate_object(channelmaster)
instance_deactivate_object(bopblock)
instance_deactivate_object(spawnerblock)
instance_deactivate_object(gate)
instance_deactivate_object(sidegate)
instance_deactivate_object(signalblock)
...
with player instance_activate_region(x-80,y-80,160,160,1)

with shell if !mario_bro_source_code instance_activate_region(x-60,y-60,120,120,1)
