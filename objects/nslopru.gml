...
if c8 && superc8 draw_background_part_ext(global.masterterrain[biome],240,64,16,16,x,y-16,1,1,$FFFFFF,1)
else if c8 && !superc8 draw_background_part_ext(global.masterterrain[biome],352,16,16,24,x,y-24,1,1,$FFFFFF,1)

draw_background_part_ext(global.masterterrain[biome],240,80,16,32,x,y,1,1,$FFFFFF,1)
