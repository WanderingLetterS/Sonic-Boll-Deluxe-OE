...
if (image_index=0) {
    if (sureface_exists("icon1")) {
        ...
        draw_surface_stretched(s,x-21,y-21,40,40)
        draw_surface_stretched(s,x-19,y-19,40,40)
        draw_surface_stretched(s,x-21,y-19,40,40)
        draw_surface_stretched(s,x-19,y-21,40,40)
        d3d_set_fog(1,$ffffff,0,0)
        draw_surface_stretched(s,x-21,y-20,40,40)
        draw_surface_stretched(s,x-19,y-20,40,40)
        draw_surface_stretched(s,x-20,y-21,40,40)
        draw_surface_stretched(s,x-20,y-19,40,40)
        d3d_set_fog(0,0,0,0)
        texture_set_interpolation(1)
        draw_surface_stretched(s,x-20,y-20,40,40)
