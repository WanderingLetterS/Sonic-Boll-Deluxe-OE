...
c9=position_meeting(x+24,y-8,fence) || x=region.x-16
c6=position_meeting(x+24,y+8,fence) || x=region.x-16
c7=position_meeting(x-8,y-8,fence) || x=region.lefthand
c4=position_meeting(x-8,y+8,fence) || x=region.lefthand
c1=position_meeting(x-8,y+24,fence) || x=region.lefthand || y=region.ky-16
c3=position_meeting(x+24,y+24,fence) || x=region.x-16 || y=region.ky-16
c8=position_meeting(x+8,y-8,fence)
