...
else if (type="btroot") with (instance_create(x,y,beetroot)) {vspeed=0 alarm[0]=-1 drop=1 p2=other.p2 depth=0}
else if (type="glui") with (instance_create(x,y,greenlui)) {vspeed=0 alarm[0]=-1 drop=1 p2=other.p2 depth=0}
