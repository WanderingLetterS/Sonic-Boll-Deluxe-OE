...
if c8 && superc8 draw_background_part_ext(global.masterterrain[biome],304,64,32,16,x,y-16,1,1,$FFFFFF,1)
else if c8 && !superc8 draw_background_part_ext(global.masterterrain[biome],432,16,32,24,x,y-24,1,1,$FFFFFF,1)

draw_background_part_ext(global.masterterrain[biome],304,80,16,32,x,y,1,1,$FFFFFF,1)
draw_background_part_ext(global.masterterrain[biome],320,80,16,16,x+16,y,1,1,$FFFFFF,1)
