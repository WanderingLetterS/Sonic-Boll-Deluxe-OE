...
applies_to=self
*/
draw_background_part_ext(global.masterobjects[biome],448,616,32,32,base.x,base.y,1,1,c_white,image_alpha)
...
draw_background_general(global.masterobjects[biome],480,552,88,96,(x-7*cos(radrot))-sin(radrot) *(96/2),(y+7*sin(radrot))-cos(radrot)*(96/2),1,1,rot,$ffffff,$ffffff,$ffffff,$ffffff,1)



draw_background_part_ext(global.masterobjects[biome],448,584,32,32,base.x,base.y,1,1,c_white,image_alpha)
