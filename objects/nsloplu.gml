...
if c8 && superc8 draw_background_part_ext(global.masterterrain[biome],256,64,16,16,x,y-16,1,1,$FFFFFF,1)
else if c8 && !superc8 draw_background_part_ext(global.masterterrain[biome],368,16,16,24,x,y-24,1,1,$FFFFFF,1)

draw_background_part_ext(global.masterterrain[biome],256,80,16,32,x,y,1,1,$FFFFFF,1)
