...
if (c8 && c2) || (!c8 && !c2) {/*middle fill*/ tile_bake(sheet,424,328,16,16,x-8,y-8,999998)}
else if (!c8 && c2) {/*top*/ tile_bake(sheet,424,344,16,16,x-8,y-8,999998)}
else if (c8 && !c2) {/*bottom*/ tile_bake(sheet,440,344,16,16,x-8,y-8,999998)}
