...
tex=sprite_get_texture(tex_runes,0)
s=-1
s2=-1
waitbitch=1
alarm[0]=2
...
if (time mod 2) {
    ...
    for (i=0;i<8;i+=1) {
        ...
        draw_vertex_texture_color(400,0,x2,y2,f[i],1)
        draw_vertex_texture_color(0,224,x4,y4,f[i],1)
        draw_vertex_texture_color(0,224,x4,y4,f[i],1)
        draw_vertex_texture_color(400,0,x2,y2,f[i],1)
        draw_vertex_texture_color(400,224,x3,y3,f[i],1)
    }
